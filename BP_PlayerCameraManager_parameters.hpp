...
static_assert(offsetof(BP_PlayerCameraManager_C_ExecuteUbergraph_BP_PlayerCameraManager, K2Node_Event_DeltaSeconds) == 0x000004, "Member 'BP_PlayerCameraManager_C_ExecuteUbergraph_BP_PlayerCameraManager::K2Node_Event_DeltaSeconds' has a wrong offset!");
...
static_assert(alignof(BP_PlayerCameraManager_C_ReceiveTick) == 0x000004, "Wrong alignment on BP_PlayerCameraManager_C_ReceiveTick");
static_assert(sizeof(BP_PlayerCameraManager_C_ReceiveTick) == 0x000004, "Wrong size on BP_PlayerCameraManager_C_ReceiveTick");
static_assert(offsetof(BP_PlayerCameraManager_C_ReceiveTick, DeltaSeconds) == 0x000000, "Member 'BP_PlayerCameraManager_C_ReceiveTick::DeltaSeconds' has a wrong offset!");
