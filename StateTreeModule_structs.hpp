...
static_assert(offsetof(FStateTreeTransitionResult, CurrentRunStatus) == 0x000010, "Member 'FStateTreeTransitionResult::CurrentRunStatus' has a wrong offset!");
static_assert(offsetof(FStateTreeTransitionResult, SourceState) == 0x000012, "Member 'FStateTreeTransitionResult::SourceState' has a wrong offset!");
static_assert(offsetof(FStateTreeTransitionResult, TargetState) == 0x000014, "Member 'FStateTreeTransitionResult::TargetState' has a wrong offset!");
static_assert(offsetof(FStateTreeTransitionResult, CurrentState) == 0x000016, "Member 'FStateTreeTransitionResult::CurrentState' has a wrong offset!");
static_assert(offsetof(FStateTreeTransitionResult, ChangeType) == 0x000018, "Member 'FStateTreeTransitionResult::ChangeType' has a wrong offset!");
static_assert(offsetof(FStateTreeTransitionResult, Priority) == 0x000019, "Member 'FStateTreeTransitionResult::Priority' has a wrong offset!");
static_assert(offsetof(FStateTreeTransitionResult, SourceStateTree) == 0x000020, "Member 'FStateTreeTransitionResult::SourceStateTree' has a wrong offset!");
static_assert(offsetof(FStateTreeTransitionResult, SourceRootState) == 0x000028, "Member 'FStateTreeTransitionResult::SourceRootState' has a wrong offset!");
...
static_assert(offsetof(FStateTreeInstanceStorage, ExecutionState) == 0x000000, "Member 'FStateTreeInstanceStorage::ExecutionState' has a wrong offset!");
static_assert(offsetof(FStateTreeInstanceStorage, InstanceStructs) == 0x000030, "Member 'FStateTreeInstanceStorage::InstanceStructs' has a wrong offset!");
static_assert(offsetof(FStateTreeInstanceStorage, TemporaryInstances) == 0x000040, "Member 'FStateTreeInstanceStorage::TemporaryInstances' has a wrong offset!");
static_assert(offsetof(FStateTreeInstanceStorage, EventQueue) == 0x000050, "Member 'FStateTreeInstanceStorage::EventQueue' has a wrong offset!");
static_assert(offsetof(FStateTreeInstanceStorage, TransitionRequests) == 0x000060, "Member 'FStateTreeInstanceStorage::TransitionRequests' has a wrong offset!");
static_assert(offsetof(FStateTreeInstanceStorage, GlobalParameters) == 0x000070, "Member 'FStateTreeInstanceStorage::GlobalParameters' has a wrong offset!");
...
static_assert(offsetof(FCompactStateTransition, ConditionsBegin) == 0x000008, "Member 'FCompactStateTransition::ConditionsBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTransition, State) == 0x00000A, "Member 'FCompactStateTransition::State' has a wrong offset!");
static_assert(offsetof(FCompactStateTransition, Delay) == 0x00000C, "Member 'FCompactStateTransition::Delay' has a wrong offset!");
static_assert(offsetof(FCompactStateTransition, Trigger) == 0x000010, "Member 'FCompactStateTransition::Trigger' has a wrong offset!");
static_assert(offsetof(FCompactStateTransition, Priority) == 0x000011, "Member 'FCompactStateTransition::Priority' has a wrong offset!");
static_assert(offsetof(FCompactStateTransition, Fallback) == 0x000012, "Member 'FCompactStateTransition::Fallback' has a wrong offset!");
static_assert(offsetof(FCompactStateTransition, ConditionsNum) == 0x000013, "Member 'FCompactStateTransition::ConditionsNum' has a wrong offset!");
...
static_assert(sizeof(FCompactStateTreeState) == 0x000038, "Wrong size on FCompactStateTreeState");
static_assert(offsetof(FCompactStateTreeState, Name) == 0x000000, "Member 'FCompactStateTreeState::Name' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, LinkedState) == 0x000008, "Member 'FCompactStateTreeState::LinkedState' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, LinkedAsset) == 0x000010, "Member 'FCompactStateTreeState::LinkedAsset' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, Parent) == 0x000018, "Member 'FCompactStateTreeState::Parent' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ChildrenBegin) == 0x00001A, "Member 'FCompactStateTreeState::ChildrenBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ChildrenEnd) == 0x00001C, "Member 'FCompactStateTreeState::ChildrenEnd' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, EnterConditionsBegin) == 0x00001E, "Member 'FCompactStateTreeState::EnterConditionsBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TransitionsBegin) == 0x000020, "Member 'FCompactStateTreeState::TransitionsBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TasksBegin) == 0x000022, "Member 'FCompactStateTreeState::TasksBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ParameterTemplateIndex) == 0x000024, "Member 'FCompactStateTreeState::ParameterTemplateIndex' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ParameterDataHandle) == 0x000026, "Member 'FCompactStateTreeState::ParameterDataHandle' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ParameterBindingsBatch) == 0x00002C, "Member 'FCompactStateTreeState::ParameterBindingsBatch' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, EnterConditionsNum) == 0x00002E, "Member 'FCompactStateTreeState::EnterConditionsNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TransitionsNum) == 0x00002F, "Member 'FCompactStateTreeState::TransitionsNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TasksNum) == 0x000030, "Member 'FCompactStateTreeState::TasksNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, InstanceDataNum) == 0x000031, "Member 'FCompactStateTreeState::InstanceDataNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, Type) == 0x000032, "Member 'FCompactStateTreeState::Type' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, SelectionBehavior) == 0x000033, "Member 'FCompactStateTreeState::SelectionBehavior' has a wrong offset!");
