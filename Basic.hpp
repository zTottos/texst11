...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09371E90;
	constexpr int32 AppendString      = 0x01117E10;
	constexpr int32 GNames            = 0x092BAAC0;
	constexpr int32 GWorld            = 0x094F5B38;
	constexpr int32 ProcessEvent      = 0x01322790;
