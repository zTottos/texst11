...
void AUltra_Dynamic_Sky_C::Approximate_Real_Sun_Moon_and_Stars(double Time_Of_Day, bool Only_Calculate_Sun, struct FVector* Sun_Vector, struct FVector* Moon_Vector, double* Real_Phase, struct FVector* Phase_Alignment, double* Celestial_Orbit, struct FLinearColor* Celestial_Yaw)
{
	static class UFunction* Func = nullptr;
...
// Function Ultra_Dynamic_Sky.Ultra_Dynamic_Sky_C.CheckCustomFogCondition
// (Event, Public, BlueprintEvent)

void AUltra_Dynamic_Sky_C::CheckCustomFogCondition()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Sky_C", "CheckCustomFogCondition");
...
// Function Ultra_Dynamic_Sky.Ultra_Dynamic_Sky_C.CustomMultiplyHeightFogDensity
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// double                                  FogDensityMultiplier                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Sky_C::CustomMultiplyHeightFogDensity(double FogDensityMultiplier)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Sky_C", "CustomMultiplyHeightFogDensity");

	Params::Ultra_Dynamic_Sky_C_CustomMultiplyHeightFogDensity Parms{};

	Parms.FogDensityMultiplier = FogDensityMultiplier;
...
// Function Ultra_Dynamic_Sky.Ultra_Dynamic_Sky_C.GetDayTime 
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// float*                                  Day_Time                                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Sky_C::GetDayTime_(float* Day_Time)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Sky_C", "GetDayTime ");

	Params::Ultra_Dynamic_Sky_C_GetDayTime_ Parms{};

	UObject::ProcessEvent(Func, &Parms);

	if (Day_Time != nullptr)
		*Day_Time = Parms.Day_Time;
}
...
void AUltra_Dynamic_Sky_C::Three_Time_Floats(double Day_0, double Dusk, double Night, bool Cached, double* Out)
{
	static class UFunction* Func = nullptr;
...
// Function Ultra_Dynamic_Sky.Ultra_Dynamic_Sky_C.ToggleDayCycle
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    bPauseDayCycle                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Sky_C::ToggleDayCycle(bool bPauseDayCycle)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Sky_C", "ToggleDayCycle");

	Params::Ultra_Dynamic_Sky_C_ToggleDayCycle Parms{};

	Parms.bPauseDayCycle = bPauseDayCycle;
